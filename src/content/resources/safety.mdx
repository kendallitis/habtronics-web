...
- How to be RESPONSIBLE:
    ...
    - Avoid launching or landing within restricted Class B, C, D, or E airspace.
        ...
        - To understand how these airspaces and charts work, please visit https://pilotinstitute.com/airspace-explained/
        - Class B airspace is the busiest airspace for other aircraft, so make sure to avoid it. For all other restricted airspaces, they can be entered if coordinated with the FAA via 9-ATO-ESA-OSG-AirspaceWaiver@faa.gov.